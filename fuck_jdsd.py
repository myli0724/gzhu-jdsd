...
headers = {
    ...
    'Accept': '*/*',
    'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/98.0.4758.102 '
                  'Safari/537.36 MicroMessenger/7.0.20.1781(0x6700143B) NetType/WIFI MiniProgramEnv/Windows '
                  'WindowsWechat/WMPF XWEB/6500',
...
if __name__ == '__main__':
    for key in key_list:
        try:
            ...
            txt = '<font color="warning">【经典诵读】</font><font color="info">已完成！</font>\n'  # 需要推送的内容
            data = {
                "msgtype": "markdown",
                "markdown": {
                    "content": txt+string
